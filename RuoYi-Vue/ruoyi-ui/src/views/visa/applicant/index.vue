<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['visa:applicant:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['visa:applicant:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['visa:applicant:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="applicantList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="护照号" align="center" prop="passportNo" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="护照号" prop="passportNo">
          <el-input v-model="form.passportNo" placeholder="请输入护照号" />
        </el-form-item>
      </el-form>
...
<script>
import { listApplicant, getApplicant, delApplicant, addApplicant, updateApplicant } from "@/api/visa/applicant"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除订单申请人基本信息编号为"' + ids + '"的数据项？').then(function() {
        return delApplicant(ids)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('visa/applicant/export', {
        ...this.queryParams
